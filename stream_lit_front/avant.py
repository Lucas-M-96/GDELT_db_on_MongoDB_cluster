def request_four(n_limit, pays_1, pays_2):
    global_start = datetime.datetime.now()

    date_range = extract_date_range(st.session_state['coll'])
    list_monthly_dfs = process_all_queries(st.session_state['coll'], date_range, n_limit, pays_1, pays_2)
...
def process_all_queries(date_range, n_limit, pays_1, pays_2):
    ...
    for i in range(len(date_range) - 1):
        ...
        list_sub_df_per_month = [df_scalar, df_res_evt_code, df_res_pers, df_res_locs, df_res_src]
